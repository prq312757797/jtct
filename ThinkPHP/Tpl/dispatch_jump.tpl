<!DOCTYPE html PUBLIC "-//W3C//DTD XHTML 1.0 Transitional//EN" "http://www.w3.org/TR/xhtml1/DTD/xhtml1-transitional.dtd">
    ...
    *{ padding: 0; margin: 0; }
    body{ background: #fff; 
	     ...
	     height:650px;
	      font-size:6px; 
	      background:url("__ROOT__/Public/images/logo_2.png") no-repeat;
    ...
    top: 12%;
    left: 5%;">
    		<img src="__ROOT__/Public/images/logo_1.png"/ style="width:42%;height:100px;">
    	</div>
	    <div class="message">
		  <!--  <div class="head"><span>提示信息:</span></div>-->
		    <div class="content">
			    ...
			    <p class="error" style="    font-size: 27px;color:#b2666a;">
			    	<img src="__ROOT__/Public/images/no_1.png"/ style="width:40px;height:40px; position: relative;top: 11px;">
			    	<?php echo($error); ?></p>
			    <?php }?>
			    <p class="detail"></p>
			    <p class="jump">
