				...
				<div class="widget-box">
					...
					<?php if(is_array($fenlei)): foreach($fenlei as $key=>$v): ?><div class="widget-content nopadding">
							...
							<?php if(is_array($v['child'])): foreach($v['child'] as $key=>$vo): ?><div class="feilei_2 show02" >
								...
								<?php if($vo["is_show"] == 1): ?><span class="peng_is_ok peng_ok" style="float: right;margin-right: 51px;">上架</span><?php endif; ?>
								<?php if($vo["is_show"] == 2): ?><span class="peng_is_ok peng_not" style="float: right;margin-right: 51px;">下架</span><?php endif; ?>
