...
<div id="content">
	...
	<div id="breadcrumb">
		...
		<a href="#" class="current">仓柜管理</a>

		<a href="canggui_add" class="add_button"><button class="btn" >+添加新仓柜</button></a>
	</div>
			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped" style="width:46%;float:left;">
							<thead>
							<tr>
								<th>编号</th>
								<th>名称</th>
							...
							<?php if(is_array($list)): foreach($list as $k=>$v): ?><tr>
									...
									<td>
										<?php if($v['lever'] == 1): ?>一级仓柜<?php else: ?>二级仓柜<?php endif; ?>
									</td>
									<td>
										<a class="btn btn-default" title="编辑" alt="编辑" href="canggui_edit/id/<?php echo ($v['id']); ?>" >
											编辑
										</a>
										<?php if($v["cannot_del"] != 1): ?><a class="btn btn-danger" style="color:white;"  title="删除" alt="删除" href="canggui_delete/id/<?php echo ($v['id']); ?>" onclick="if(confirm('确认删除吗？')==false)return false;">
											删除
										</a><?php endif; ?>
									</td>
						...
						<table class="table table-bordered table-striped" style="width:46%;float:right;">
							<thead>
							<tr>
								<th>编号</th>
								<th>名称</th>
							...
							<tbody>
							<?php if(is_array($list02)): foreach($list02 as $k=>$v): ?><tr>
									<td><?php echo $k+1;?></td>
									<td><?php echo ($v["title"]); ?></td>
									<td><?php echo ($v["remark"]); ?></td>
									<td>
									...
									<td>
										<a class="btn btn-default" title="编辑" alt="编辑" href="warehouse_0_canggui_edit/id/<?php echo ($v['id']); ?>" >
											编辑
										</a>
										<?php if($v["cannot_del"] != 1): ?><a class="btn btn-danger" style="color:white;"  title="删除" alt="删除" href="warehouse_0_canggui_delete/id/<?php echo ($v['id']); ?>" onclick="if(confirm('确认删除吗？')==false)return false;">
											删除
										</a><?php endif; ?>
									</td>
								</tr><?php endforeach; endif; ?>
...
<script>
	...
	$(".peng_is_ok").click(function(){
		...
		var that = this;
		 $.post('/adp.php/Index/ajax_change_show',{'id':onw_id,'from_id':"2"},function(date){
	        if(date==1){
