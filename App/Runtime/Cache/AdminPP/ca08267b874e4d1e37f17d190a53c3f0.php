...
<div id="sidebar">
	 	...
	 	<ul>
			<li ><a href="<?php echo U('Goodsavec/selling');?>"><i class="icon icon-shopping-cart"></i> 
					<span>上架中</span></a></li>
			<li><a href="<?php echo U('Goodsavec/cangku');?>"><i class="icon icon-shopping-cart"></i> 
					<span>仓库中</span></a></li>
			<li><a href="<?php echo U('Goodsavec/huishou');?>"><i class="icon icon-shopping-cart"></i> 
					<span>回收站</span></a></li>
			<li><a href="<?php echo U('Goodsavec/fenlei');?>"><i class="icon icon-shopping-cart"></i> 
					<span>存酒分类</span></a></li>
...
<div id="content">
	...
	<div id="breadcrumb">
		...
		<a href="#" class="current">商品管理</a>
		 ...
		 <a href="/adp.php/Goodsavec/goods_add_ktv" class="add_button"><button class="btn" >+添加商品</button></a>
	</div>
						...
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<?php if(is_array($goods)): foreach($goods as $key=>$v): ?><tr>
									...
									<td>
										<li>
										<?php if($program_id == JT201808090855119076): ?><a class="btn btn-default"  title="修改" alt="修改" href="/adp.php/Goodsavec/goods_edit_ktv/id/<?php echo ($v['id']); ?>" >修改</a>
		                            	...
		                            	<?php if($program_id != JT201808090855119076): ?><li class="m_goods">
