...
<div id="content">
	...
	<div id="breadcrumb">
		...
		<a href="#" class="current">商品管理</a>
		 ...
		 <!--<a href="/adp.php/Goodsbear/goods_add_ktv" class="add_button"><button class="btn" >+添加商品</button></a>-->
	</div>
						...
						<table class="table table-bordered table-striped">
							...
							<tbody>
								<?php if(is_array($goods)): foreach($goods as $key=>$v): ?><tr>
									...
									<td>
										<li>
										<?php if($program_id == JT201808090855119076): ?><a class="btn btn-default"  title="修改" alt="修改" href="/adp.php/Goodsbear/goods_edit_ktv/id/<?php echo ($v['id']); ?>" >修改</a>
										...
										<!--&lt;!&ndash;<?php if($head_menu == 6): ?>-->
										    <div class="btn btn-default make_jingpin" a="<?php echo ($v["id"]); ?>" >
