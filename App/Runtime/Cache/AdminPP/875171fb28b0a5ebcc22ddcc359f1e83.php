...
<div id="sidebar">
		...
		<ul>
			<?php if($program_id != JT201807211029396429): ?><!--不是锡安洗衣-->
				<li ><a href="<?php echo U('Order/index');?>"><i class="icon icon-shopping-cart"></i>
					<span>订单概述</span></a></li>
				<li><a href="<?php echo U('Order/allder_fukuan');?>"><i class="icon icon-shopping-cart"></i>
					<span>待付款</span></a></li>
				<li><a href="<?php echo U('Order/allder_fahuo');?>"><i class="icon icon-shopping-cart"></i>
					<span>待发货</span></a></li>
				<li><a href="<?php echo U('Order/allder_shouhuo');?>"><i class="icon icon-shopping-cart"></i>
					<span>待收货</span></a></li>
				<li><a href="<?php echo U('Order/allder_pingjia');?>"><i class="icon icon-shopping-cart"></i>
					<span>待评价</span></a></li>
				<li><a href="<?php echo U('Order/allder_wancehgn');?>"><i class="icon icon-shopping-cart"></i>
					<span>已完成</span></a></li>
				<li><a href="<?php echo U('Order/allder_tuikuan');?>"><i class="icon icon-shopping-cart"></i>
					<span>待退款</span></a></li>
				<li><a href="<?php echo U('Order/allder_close');?>"><i class="icon icon-shopping-cart"></i>
					<span>已关闭</span></a></li>
			<?php else: ?>
				<li ><a href="<?php echo U('Order/index');?>"><i class="icon icon-shopping-cart"></i>
					<span>订单概述</span></a></li>
				...
				<li><a href="<?php echo U('Order/allder_tuikuan');?>"><i class="icon icon-shopping-cart"></i>
					<span>待退款</span></a></li>
				<li><a href="<?php echo U('Order/allder_close');?>"><i class="icon icon-shopping-cart"></i>
					<span>已关闭</span></a></li><?php endif; ?>
			
			<li><a href="<?php echo U('Order/order_all');?>"><i class="icon icon-shopping-cart"></i>
				<span><?php if($program_id == JT201806151732369242): ?>全部订单(发货订单)<?php else: ?>全部订单<?php endif; ?></span></a></li>
			
			<?php if($program_id == JT201806151732369242): ?><li><a href="<?php echo U('Order/order_hexiao');?>"><i class="icon icon-shopping-cart"></i>
					...
					<div class="span12 center" style="text-align: center;">					
						<ul class="stat-boxes" style="width:100%;">
							<li style="width:10%;    height: 60px;">
								<div class="right title_self" >今日成交</div>
							</li>
							<li style="width:20%;">
								<div class="right con_self" >成交量<strong><?php echo ($data["t"]["num"]); ?></strong></div>
							</li>
							<li style="width:20%;">
								<div class="right con_self">成交额<strong><?php if(empty($data['t']['sum'])): ?>0<?php else: echo ($data["t"]["sum"]); endif; ?></strong></div>
							</li>
						</ul>
						
						<ul class="stat-boxes" style="width:100%;">
							<li style="width:10%;    height: 60px;">
								<div class="right title_self" >昨日成交</div>
							</li>
							<li style="width:20%;">
								<div class="right con_self" >成交量<strong><?php echo ($data["y"]["num"]); ?></strong></div>
							</li>
							<li style="width:20%;">
								<div class="right con_self">成交额<strong><?php if(empty($data['y']['sum'])): ?>0<?php else: echo ($data["y"]["sum"]); endif; ?></strong></div>
							</li>
						</ul>
						
						<ul class="stat-boxes" style="width:100%;">
							<li style="width:10%;    height: 60px;">
								<div class="right title_self" >近7日成交</div>
							</li>
							<li style="width:20%;">
								<div class="right con_self" >成交量<strong><?php echo ($data["w"]["num"]); ?></strong></div>
							</li>
							<li style="width:20%;">
								<div class="right con_self">成交额<strong><?php if(empty($data['w']['sum'])): ?>0<?php else: echo ($data["w"]["sum"]); endif; ?></strong></div>
							</li>
						</ul>
						<ul class="stat-boxes" style="width:100%;">
							<li style="width:10%;    height: 60px;">
								<div class="right title_self" >近1个月成交</div>
							</li>
							<li style="width:20%;">
								<div class="right con_self" >成交量<strong><?php echo ($data["m"]["num"]); ?></strong></div>
							</li>
							<li style="width:20%;">
								<div class="right con_self">成交额<strong><?php if(empty($data['m']['sum'])): ?>0<?php else: echo ($data["m"]["sum"]); endif; ?></strong></div>
							</li>
						</ul>
					</div>	
				</div>
