...
<?php if($program_id != JT201711081030423109): ?><li class="btn btn-inverse"><a title="" href="<?php echo U('FuWuinfo/tiezi');?>"><i class="icon icon-fullscreen"></i> 
		...
		<div id="sidebar">
			<ul>
				<li><a href="<?php echo U('Assistant/manager_list');?>"><i class="icon icon-shopping-cart"></i>
				<span>平台管理员</span></a></li>
				
				<li><a href="<?php echo U('Assistant/order_ing');?>"><i class="icon icon-shopping-cart"></i>
				<span>订单提醒</span></a></li>
<!--店员管理-->

				<li class="submenu open">
					<a href="<?php echo U('Assistant/assistant_is');?>"><i class="icon icon-th-list"></i> 
						<span>店员管理</span> <span class="label">3</span></a>
					<ul>
						<li><a href="<?php echo U('Assistant/assistant_is');?>">
							<span>申请中<span style="color:red;"> ( <?php echo ($assistant_is); ?> ) </span></span>
						</a></li>
						<li><a href="<?php echo U('Assistant/assistant_ing');?>">
							<span>服务中<span style="color:red;"> ( <?php echo ($assistant_ing); ?> ) </span></span>
						</a></li>
						<li><a href="<?php echo U('Assistant/assistant_stop');?>">
...
<div id="content">
	...
	<div id="breadcrumb">
		<a href="#" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 多商户</a>
		<a href="#" class="current">店员申请</a>
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped">
							...
							<?php if(is_array($list)): foreach($list as $key=>$v): ?><tr>
									...
									<td>
										<?php if($v['state'] == 0): ?>待审核<?php endif; ?>
										<?php if($v['state'] == 1): ?>服务中<?php endif; ?>
										<?php if($v['state'] == 2): ?>已暂停<?php endif; ?>
										<?php if($v['state'] == 3): ?>已拒绝<?php endif; ?>
									</td>
									<td>
										<?=date("Y-m-d H:i:s",$v['time_registe']);?>
									</td>
									
									<td>
										<!--<button class="btn btn-default">
											<a  title="详情" alt="详情" href="assistant_con/id/<?php echo ($v['id']); ?>" >查看详情</a>
										</button>-->
										<a style="color:white;" class="btn btn-danger"  title="处理申请" alt="处理申请" href="assistant_agree/id/<?php echo ($v['id']); ?>" onclick="if(confirm('确认通过申请吗？')==false)return false;">通过申请</a>
										<a style="color:white;" class="btn btn-danger"  title="拒绝申请" alt="拒绝申请" href="assistant_say_no/id/<?php echo ($v['id']); ?>" onclick="if(confirm('确认拒绝申请吗？')==false)return false;">拒绝申请</a>
