...
<div id="content">
	...
	<div id="breadcrumb">
		<a href="<?php echo U('Room/index');?>" title="Go to Home" class="tip-bottom"><i class="icon-home"></i> 首页</a>
		<a href="<?php echo U('Room/room_list');?>" class="tip-bottom">歌房管理</a>
			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form action="<?php echo U('Room/run_room_list_add',array('id'=>$info['id']));?>" method="post" enctype="multipart/form-data" class="form-horizontal" />
							...
							<div class="control-group">
								...
								<div class="controls">
									<input type="text" name="room_num" value="<?php echo ($info['room_num']); ?>" />
								</div>
							</div>
					<!--商品分类-->
							<div class="control-group">
								...
								<div class="controls">
									<div class="controls input_select ml0 w40">
										<select name="fenlei_1_title" class="w100" onchange="gradeChange()" id="city_area_select" >
											<?php if(empty($info)): ?><option >请选择分类</option>
												<?php else: ?>
									...
									<div class="controls  input_select ml12 w40">
										<select name="fenlei_2_title" class="w100" id="road_from_select" >
											<?php if(empty($info)): ?><option>请选择子分类</option>
												<?php else: ?>
							...
							<div class="control-group">
								...
								<?php if(empty($info)): ?><div class="controls">
									...
									<div class="controls">
										<label class="radio-inline is_show">
				                            <input type="radio" name="is_show" value="0" <?php if($info["is_show"] == 0): ?>checked="checked"<?php endif; ?>> 空闲
				                    	</label>
				                        <label class="radio-inline is_show">
				                        	<input type="radio" name="is_show" value="1" <?php if($info["is_show"] == 1): ?>checked="checked"<?php endif; ?>> 服务中
				                        </label>
				                        <label class="radio-inline is_show">
				                        	<input type="radio" name="is_show" value="2" <?php if($info["is_show"] == 2): ?>checked="checked"<?php endif; ?>> 清台中
				                        </label>
				                        <label class="radio-inline is_show">
				                        	<input type="radio" name="is_show" value="3" <?php if($info["is_show"] == 3): ?>checked="checked"<?php endif; ?>> 关闭
				                        </label>
									</div><?php endif; ?>
							...
							<?php if(!empty($info)): ?><div class="control-group">
									...
									<div class="controls">
										<img src="<?php echo ($info["room_check_code"]); ?>"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">在线酒水二维码</label>
									<div class="controls">
										<img src="<?php echo ($info["onlinebeer_code"]); ?>"/>
									</div>
								</div>
								<div class="control-group">
									<label class="control-label">存酒二维码</label>
									<div class="controls">
										<img src="<?php echo ($info["savebeer_code"]); ?>"/>
									</div>
								</div><?php endif; ?>
