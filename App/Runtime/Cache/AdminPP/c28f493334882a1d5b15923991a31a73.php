				...
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<table class="table table-bordered table-striped" style="    border-top: 1px solid #ccc;">
							...
							<tbody>
							<?php if(is_array($list)): foreach($list as $key01=>$v): if(is_array($v['warehouse'])): foreach($v['warehouse'] as $key02=>$vo): ?><tr >
									<td>
										<?php echo ($vo["warehouse"]); ?>
									<?php if($vo['lever'] == 1): ?><span style="color:red;">(总仓)</span><?php endif; ?>
									</td>
									<td><?php echo ($v["fenlei_1_title"]); ?></td>
									<td><?php echo ($v["fenlei_2_title"]); ?></td>
