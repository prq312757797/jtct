			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form action="<?php echo U('Warehouse/run_fenlei_add',array('id'=>$info['id']));?>" method="post" enctype="multipart/form-data" class="form-horizontal" />
...
<?php if($program_id == JT201805020920374826): ?><div class="control-group">
						...
						<!--<div class="control-group">-->
							...
							<!--<?php if(empty($info)): ?>-->
								...
								<!--</div>-->
								<!--<?php else: ?>-->
								<!--<?php if($info["is_index_recommend"] == 1): ?>-->
									<!--<div class="controls">-->
										<!--<label class="radio-inline is_show">-->
											<!--<input type="radio" name="is_index_recommend" value="1" checked=""> 启用-->
										<!--</label>-->
									...
									<!--</div>-->
								<!--<?php endif; ?>-->
								<!--<?php if($info["is_index_recommend"] == 2): ?>-->
									<!--<div class="controls">-->
										<!--<label class="radio-inline is_show">-->
