				...
				<div class="widget-box">
					...
					<?php if(is_array($fenlei)): foreach($fenlei as $key=>$v): ?><div class="widget-content nopadding">
							...
							<div class="feilei">
								...
								<!--<a class="btn btn-default" style="float: right; margin-top: -5px;"  title="删除" alt="删除" href="fenlei_delete/id/<?php echo ($v['id']); ?>" onclick="if(confirm('确认删除吗？')==false)return false;"><i class="icon icon-trash"></i> </a>
							-->
							...
							<?php if(is_array($v['child'])): foreach($v['child'] as $key=>$vo): ?><div class="feilei_2 show02" >
