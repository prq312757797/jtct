		...
		<div id="content">
			...
			<div id="breadcrumb">
				...
				<a href="#" class="current">歌房管理</a>
				 ...
				 <a href="room_list_add" class="add_button"><button class="btn" >+添加歌房</button></a>
			</div>
						...
						<div class="widget-box">
							...
							<div class="widget-content nopadding">
								<table class="table table-bordered table-striped">
									...
									<tbody>
										<?php if(is_array($huandeng)): foreach($huandeng as $key=>$v): ?><tr>
											<td><?php echo ($v["id"]); ?></td>
											<td><?php echo ($v["sort"]); ?></td>
											<td><?php echo ($v["room_num"]); ?></td>
											<td><?php echo ($v["fenlei_1_title"]); ?>-<?php echo ($v["fenlei_2_title"]); ?></td>
											<td>
												<a  title="修改" alt="修改" href="room_list_edit/id/<?php echo ($v['id']); ?>" >
													<button class="btn btn-default">修改</button>
												</a>
												<a style="color:white;"  title="删除" alt="删除" href="room_list_delete/id/<?php echo ($v['id']); ?>" onclick="if(confirm('确认删除吗？')==false)return false;">
