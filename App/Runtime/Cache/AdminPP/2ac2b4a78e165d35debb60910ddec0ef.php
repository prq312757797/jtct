...
<div id="content">
	...
	<div id="breadcrumb">
		...
		<a href="<?php echo U('Distribution/fx_lever');?>" class="tip-bottom">分销佣金管理</a>
		<a href="#" class="current">编辑分销商等级</a>
	</div>
			...
			<div class="span12">
				<div class="widget-box">
					...
					<div class="widget-content nopadding">
						<form action="<?php echo U('Distribution/fx_lever_run_add',array('id'=>$info['id']));?>" method="post" enctype="multipart/form-data" class="form-horizontal" />
						...
						<div class="control-group">
							<label class="control-label">一级佣金比例</label>
							<div class="controls">
								<input type="text" name="bl_lever_1" value="<?php echo ($info['bl_lever_1']); ?>" /> %
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">二级佣金比例</label>
							<div class="controls">
								<input type="text" name="bl_lever_2" value="<?php echo ($info['bl_lever_2']); ?>" /> %
							</div>
						</div>
						<div class="control-group">
							<label class="control-label">三级佣金比例</label>
							<div class="controls">
								<input type="text" name="bl_lever_3" value="<?php echo ($info['bl_lever_3']); ?>" /> %
							</div>
						</div>
